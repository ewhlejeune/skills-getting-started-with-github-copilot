...
activities = {
    ...
    "Drama Club": {
        "description": "Performances, improv, and stagecraft for budding actors",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["ella@mergington.edu", "jack@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Challenge your problem solving with advanced math topics",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["oliver@mergington.edu", "mia@mergington.edu"]
    },
    "Science Club": {
        "description": "Explore experiments, science fair projects, and research",
